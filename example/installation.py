"""
This is an example web page to showcase the fletxible library.
Make sure you configure the fx_config file to include the installation.py file. 

1. Add this file to your web directory after running fletxible-init.
2. Configure the fx_config.yaml file.
3. Run the script.py file, then run the main.py file.
...
class FxView(ft.View):
    def __init__(
        ...
        page: ft.Page,
        docs: dict,
        route="/installation",  # set your routes here ...
        # bgcolor="#2e303d",
        bgcolor="#23262d",
        padding=0,
    ) -> None:
